...
- **Hold continuous history:** Each Channel numbers, orders, and recovers its own messages without mixing unrelated chats.
...
- A **Message** belongs to one Channel, and its ordering boundary is that Channel.
