...
Continue with [Message](/en/guide/core-concepts/messages) and [Conversations & Unread Counts](/en/guide/core-concepts/conversations). For server-side construction and paging, continue to the [message-flow architecture guide](/en/server/architecture/message-flow).
