...
Continue with [Message](/en/guide/core-concepts/messages), then choose your [full SDK platform](/en/sdk/wukongim) for conversation APIs. For server-side construction and paging, continue to the [message-flow architecture guide](/en/server/architecture/message-flow).
