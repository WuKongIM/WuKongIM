...
WuKongIM gets a message to its target Channel. Your application defines what the content means and how clients display or process it.

## Why messages matter

- **Carry product content:** The same messaging path can carry chat content or custom business events.
- **Work online and offline:** An online recipient can receive a message in realtime; an offline or reconnecting device can recover committed Channel history.
