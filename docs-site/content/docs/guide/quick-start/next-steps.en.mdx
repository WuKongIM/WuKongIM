...
<Cards>
  ...
  <Card title="Server" description="Continue to configuration, operations, tooling, and architecture menus." href="/en/server" />
  <Card title="Kubernetes (Beta)" description="Plan persistence, service discovery, resources, and release boundaries." href="/en/server/deployment/kubernetes" />
  <Card title="Upgrade & Migration" description="Freeze compatibility evidence before choosing a rolling upgrade, maintenance window, or separate migration." href="/en/server/operations/upgrade-and-migration" />
</Cards>
