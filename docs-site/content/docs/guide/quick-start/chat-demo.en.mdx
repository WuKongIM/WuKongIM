...
The Chat Demo is a browser application embedded in the `wukongim` binary. After the source quick start launches the server, no separate frontend development process is required.

## Entry points

| Environment | Chat Demo address | API base URL |
| --- | --- | --- |
| Source single-node cluster | `http://127.0.0.1:5001/demo/` | Same origin as the page |
