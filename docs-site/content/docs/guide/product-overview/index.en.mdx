...
<Callout type="warn" title="v3 Beta">
  WuKongIM v3 is still in beta. APIs, configuration, and storage formats may change before the stable release. Before production use, review [Upgrade & Migration](/en/server/operations/upgrade-and-migration), [Security & Permissions](/en/server/configuration/security), and [Health & Monitoring](/en/server/operations/health-and-monitoring).
</Callout>
