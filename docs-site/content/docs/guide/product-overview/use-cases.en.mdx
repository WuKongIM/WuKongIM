...
Start with the [Quick Start](/en/guide/quick-start) to run a single-node cluster and send the first message. During integration, read [Messaging Integration](/en/guide/integration/messaging). Before launch, complete [Integration Acceptance](/en/guide/integration/acceptance) and the [Production Checklist](/en/server/deployment/production-checklist), then use [`wkbench`](/en/server/tools/wkbench) to validate capacity with a representative workload.
