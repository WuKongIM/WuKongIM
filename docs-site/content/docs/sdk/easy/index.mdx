...
<Callout type="info" title="四端源码 example 与正式发布包均已跑通">
  2026 年 8 月 31 日，四个官方 example 完成源码运行；9 月 1 日，npm `2.0.4`、Maven Central `1.0.5`、CocoaPods `1.1.1` 与 pub.dev `1.1.0` 又连接同一 WuKongIM `5676700d2dc966fa6fc9b2f0620a6ae429adad5a` 完成 Alice/Bob 在线双向消息和断开清理。托管任务见[正式包验收运行](https://github.com/WuKongIM/WuKongIM/actions/runs/33466063708)，浏览器包另在 Chrome 151 通过。这仍不是物理真机、WSS、离线能力或生产 Token 校验凭据。
</Callout>
