...
<Callout type="info" title="四端官方 example 已跑通">
  2026 年 8 月 31 日，Web、Android、iOS 与 Flutter 官方 example 都已连接 WuKongIM `5676700d2dc966fa6fc9b2f0620a6ae429adad5a`，完成 Alice/Bob 在线双向消息；对应构建、测试、模拟器或浏览器环境见[可复现运行记录](/zh/sdk/easy/examples)。这仍不是物理真机、WSS、离线能力或生产 Token 校验凭据。
</Callout>

| 平台 | 已验证 example revision | 与正式版本的关系 |
| --- | --- | --- |
| Web | [`a055b3667247333b6b3183249f5d5929673dfd53`](https://github.com/WuKongIM/WuKongEasySDK-JS/commit/a055b3667247333b6b3183249f5d5929673dfd53) | 比 npm `2.0.3` 更新，尚未作为新版本发布 |
| Android | [`7134bbd0263fd01d9e7f71b7bd05b226f75b2292`](https://github.com/WuKongIM/WuKongEasySDK-Android/commit/7134bbd0263fd01d9e7f71b7bd05b226f75b2292) | 比 Maven `1.0.4` 更新，尚未作为新版本发布 |
| iOS | [`40014c16c0becd390c105098d359048901f4d87c`](https://github.com/WuKongIM/WuKongEasySDK-iOS/commit/40014c16c0becd390c105098d359048901f4d87c) | 比 iOS `1.1.0` 更新，尚未作为新版本发布 |
...
<Callout type="warn" title="不要把 main 的运行结果归给旧发布包">
  教程安装段继续固定当前正式版本；复现 example 结果则必须检出上表 revision。Web、Android 与 iOS 的新提交包含 example 和连接生命周期修复，在它们进入下一正式版本前，两类证据必须分开记录。
</Callout>
