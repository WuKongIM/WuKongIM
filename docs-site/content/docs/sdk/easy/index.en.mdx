...
<Callout type="info" title="All four official examples have run successfully">
  On August 31, 2026, the Web, Android, iOS, and Flutter official examples connected to WuKongIM `5676700d2dc966fa6fc9b2f0620a6ae429adad5a` and completed Alice/Bob online bidirectional messaging. The builds, tests, emulators, and browser are recorded in the [reproducible runbook](/en/sdk/easy/examples). This is still not physical-device, WSS, offline, or production-token evidence.
</Callout>

| Platform | Verified example revision | Relationship to the release |
| --- | --- | --- |
| Web | [`a055b3667247333b6b3183249f5d5929673dfd53`](https://github.com/WuKongIM/WuKongEasySDK-JS/commit/a055b3667247333b6b3183249f5d5929673dfd53) | Ahead of npm `2.0.3`; not yet published as a new version |
| Android | [`7134bbd0263fd01d9e7f71b7bd05b226f75b2292`](https://github.com/WuKongIM/WuKongEasySDK-Android/commit/7134bbd0263fd01d9e7f71b7bd05b226f75b2292) | Ahead of Maven `1.0.4`; not yet published as a new version |
| iOS | [`40014c16c0becd390c105098d359048901f4d87c`](https://github.com/WuKongIM/WuKongEasySDK-iOS/commit/40014c16c0becd390c105098d359048901f4d87c) | Ahead of iOS `1.1.0`; not yet published as a new version |
...
<Callout type="warn" title="Do not attribute a main-source run to an older package">
  The installation sections remain pinned to current releases; reproducing the example results requires the revisions above. The newer Web, Android, and iOS commits contain example and connection-lifecycle fixes. Keep the two evidence classes separate until those commits ship in new releases.
</Callout>
