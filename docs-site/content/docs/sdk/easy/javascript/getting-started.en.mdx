...
- **You need a runnable full-SDK Web example:** use the [WuKongIMJSSDK Web tutorial](/en/sdk/javascript) and its repository example, then check the current package and runtime matrix under [Versions & Compatibility](/en/api/compatibility). Do not mix method names between the two SDKs.
