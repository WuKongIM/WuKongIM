...
This revision is the released `v1.1.0`. [Run the Official Examples](/en/sdk/easy/examples) covers server preparation, device addressing, and Alice/Bob acceptance for both the source example and hosted artifact.
