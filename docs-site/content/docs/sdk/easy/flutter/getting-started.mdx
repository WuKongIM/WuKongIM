...
该闭环没有证明应用从后台恢复、离线消息同步或多端会话一致性。继续按[消息收发](/zh/guide/integration/messaging)和[重连与异常处理](/zh/guide/integration/acceptance)补齐。
...
回到 [WuKongEasySDK 概览](/zh/sdk/easy)，或继续阅读[消息收发](/zh/guide/integration/messaging)、[会话与未读数](/zh/guide/core-concepts/conversations)和[上线验收](/zh/guide/integration/acceptance)。
