...
- Ordinary RPC, Raft and control frames batch already-ready work without waiting for future frames. Only isolated bulk traffic retains the bounded coalescing delay.
