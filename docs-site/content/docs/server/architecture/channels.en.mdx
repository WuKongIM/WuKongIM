...
Consequently, "the large-group message committed" and "every online member received it" are different events. Delivery or conversation-projection failures do not roll back the committed log.
