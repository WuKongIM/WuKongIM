...
Before production, validate an archive with [Backup & Restore](/en/server/operations/backup-and-restore) and use [`wkbench`](/en/server/tools/wkbench) to test capacity with a representative workload.
