---
title: v2 → v3 Migration Reference
description: Multi-node plans, plugins, compatibility policies, troubleshooting, and cutover acceptance.
---

Start with the [v2 → v3 migration walkthrough](/en/server/operations/v2-to-v3-migration). Use this reference for multi-node deployments, plugins, and troubleshooting. Review optional policies against your own business requirements.
