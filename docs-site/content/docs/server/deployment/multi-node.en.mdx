...
6. Start services after every node is prepared; a static three-replica cluster needs a majority to establish write routing.
...
- stopping one node in pre-production produces behavior within the capacity and failure objectives;
