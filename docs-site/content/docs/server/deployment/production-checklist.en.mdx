...
This page is for the **first launch of a new environment**. For a version upgrade, first determine whether old and new versions may run together, then use [Upgrade & Migration](/en/server/operations/upgrade-and-migration) to choose a rolling update, maintenance window, or separate migration.
