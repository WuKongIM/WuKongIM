...
Complete backup and restore instructions remain part of the planned operations documentation. A backup without a recovery drill is not complete evidence.
