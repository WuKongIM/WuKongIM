...
Apply these values in [Multi-device Sync](/en/sdk/common-guides/multi-device), then use [Identity & Token](/en/sdk/common-guides/identity-and-token) for issuance and revocation.
