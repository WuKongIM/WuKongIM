...
Apply these values with the [Device](/en/guide/core-concepts/devices) model, then use [Authentication & Security](/en/guide/integration/authentication) for issuance and revocation.
