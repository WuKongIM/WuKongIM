...
| notification | `recvack` | → `RECVACK` | confirms online delivery on an authenticated session; iOS `v1.0.3` sends both camelCase `messageId` and `messageSeq` |
