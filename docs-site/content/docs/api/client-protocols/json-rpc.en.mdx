...
| notification | `recvack` | → `RECVACK` | confirms online delivery on an authenticated session; iOS `v1.1.0` sends both camelCase `messageId` and `messageSeq` |
