...
See [Message Flags](/en/api/dictionaries/message-flags) for fixed-header and Setting bits, [Device Flags](/en/api/dictionaries/device-flags) for device values, [Channel Types](/en/api/dictionaries/channel-types) for Channel values, and [Reason Codes](/en/api/dictionaries/reason-codes) for outcomes.
