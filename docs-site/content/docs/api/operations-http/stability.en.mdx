...
| Surface | Audience | Stability | Public OpenAPI? |
| --- | --- | --- | --- |
| `/healthz`, `/readyz` | Operator | Stable | May form a separate Operations HTTP contract |
| `/metrics` | Operator | Stable Prometheus format | No; it is not a JSON API |
| `/top/v1/snapshot` | Operator | Unstable | No; document version and boundary only |
