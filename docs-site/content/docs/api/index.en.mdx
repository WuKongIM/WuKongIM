...
<Cards>
  ...
  <Card title="Product HTTP API" description="All 41 business HTTP operations registered by the current source." href="/en/api/product-http" />
  ...
  <Card title="Client Protocols" description="WKProto frames, lifecycle, encryption, and experimental JSON-RPC." href="/en/api/client-protocols" />
...
- JSON-RPC has a codec contract only; the current Product Gateway does not support it as a client integration.
