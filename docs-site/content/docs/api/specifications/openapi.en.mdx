...
| --- | --- | --- | --- |
| Product HTTP | 44 current business HTTP operations | No built-in business authentication; trusted backends only | [JSON](/contracts/product-http.openapi.json) |
...
| Channel & Conversation | 15 | Reviewed 10-Channel and 6-Conversation subset | [JSON](/contracts/product-http-management.openapi.json) |
