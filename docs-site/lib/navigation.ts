  ...
  return publishedGroup(
    ...
    [
      publishedPage(
        ...
        '已发布 v1.1.0 源码教程；JSON-RPC CONNECT 与在线双向收发已有服务端线协议验证，iOS 构建和设备运行仍需自验。',
        'Published for v1.1.0; JSON-RPC CONNECT and online bidirectional messaging have a server-side wire receipt, while iOS build and device execution remain deployment-owned.',
      ),
      publishedPage(
        'android/getting-started',
        '5 分钟集成 Android',
        '5-minute Android integration',
        '已发布 v1.0.4 源码教程；JSON-RPC CONNECT 与在线双向收发已有服务端线协议验证，Android 构建和设备运行仍需自验。',
        'Published for v1.0.4; JSON-RPC CONNECT and online bidirectional messaging have a server-side wire receipt, while Android build and device execution remain deployment-owned.',
      ),
      publishedPage(
        'flutter/getting-started',
        '5 分钟集成 Flutter',
        '5-minute Flutter integration',
        '已发布 v1.1.0 源码教程；JSON-RPC CONNECT 与在线双向收发已有服务端线协议验证，Flutter 构建和设备运行仍需自验。',
        'Published for v1.1.0; JSON-RPC CONNECT and online bidirectional messaging have a server-side wire receipt, while Flutter build and device execution remain deployment-owned.',
      ),
      publishedPage(
        'javascript/getting-started',
        '5 分钟集成 Web',
        '5-minute Web integration',
        '已发布 v2.0.3 源码教程；JSON-RPC CONNECT 与在线双向收发已有服务端线协议验证，浏览器产物运行仍需自验。',
        'Published for v2.0.3; JSON-RPC CONNECT and online bidirectional messaging have a server-side wire receipt, while browser artifact execution remains deployment-owned.',
      ),
    ],
  );
}
