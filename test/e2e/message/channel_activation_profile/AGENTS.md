...
This scenario is for agents working on `test/e2e/message/channel_activation_profile`.
...
```bash
WK_E2E_CHANNEL_ACTIVATION_PROFILE=1 go test -tags=e2e ./test/e2e/message/channel_activation_profile -count=1
```
...
go test -tags=e2e ./test/e2e/message/channel_activation_profile -count=1
```
