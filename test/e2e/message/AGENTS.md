...
| `wukongimv2_single_node_send` | Prove `cmd/wukongimv2` can complete one single-node cluster WKProto SEND -> SENDACK closure. | `GOWORK=off go test -tags=e2e ./test/e2e/message/wukongimv2_single_node_send -count=1` |
