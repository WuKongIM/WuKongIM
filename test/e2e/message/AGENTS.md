...
| `delivery_tag_group_delivery` | Prove group-channel delivery uses delivery tag partitions and refreshes after public subscriber mutations. | `go test -tags=e2e ./test/e2e/message/delivery_tag_group_delivery -count=1` |
