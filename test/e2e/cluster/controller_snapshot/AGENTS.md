...
This file is for agents working on `test/e2e/cluster/controller_snapshot`.
...
`go test -tags=e2e ./test/e2e/cluster/controller_snapshot -count=1`

Opt-in large snapshot run:

`WK_E2E_CONTROLLER_SNAPSHOT=1 WK_E2E_CONTROLLER_SNAPSHOT_ROWS=700 WK_E2E_CONTROLLER_SNAPSHOT_PAYLOAD_BYTES=131072 WK_E2E_CONTROLLER_SNAPSHOT_BATCH_ROWS=50 go test -timeout=25m -tags=e2e ./test/e2e/cluster/controller_snapshot -run TestControllerFollowerRestoresLargeSnapshot -count=1 -v`
