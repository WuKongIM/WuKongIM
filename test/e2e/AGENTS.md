...
| `message` | `test/e2e/message/easy_sdk_docs_release` | Prove the released npm Web EasySDK tutorial in Chromium with compilation, bidirectional messaging, cleanup, reconnect and bounded connection deadlines. | `WK_E2E_EASYSDK_ARTIFACTS=/absolute/artifact-directory GOWORK=off go test -tags=e2e ./test/e2e/message/easy_sdk_docs_release -count=1 -timeout=5m -p=1 -v` |
