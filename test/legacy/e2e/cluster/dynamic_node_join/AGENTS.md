...
This file is for agents working on `test/legacy/e2e/cluster/dynamic_node_join`.
...
`go test -tags=e2e,legacy_e2e ./test/legacy/e2e/cluster/dynamic_node_join -count=1`

Opt-in large snapshot run:

`WK_E2E_LARGE_SNAPSHOT=1 WK_E2E_SNAPSHOT_ROWS=1200 WK_E2E_SNAPSHOT_PAYLOAD_BYTES=65536 WK_E2E_SNAPSHOT_BATCH_ROWS=100 go test -timeout=20m -tags=e2e,legacy_e2e ./test/legacy/e2e/cluster/dynamic_node_join -run TestDynamicNodeJoinLargeSlotSnapshotOnboarding -count=1 -v`
