...
This file is for agents working on `test/legacy/e2e/message/cross_node_closure`.
...
`go test -tags=e2e,legacy_e2e ./test/legacy/e2e/message/cross_node_closure -count=1`
