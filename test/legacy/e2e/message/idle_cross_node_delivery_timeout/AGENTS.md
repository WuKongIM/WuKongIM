...
This file is for agents working on `test/legacy/e2e/message/idle_cross_node_delivery_timeout`.
...
`go test -tags=e2e,legacy_e2e ./test/legacy/e2e/message/idle_cross_node_delivery_timeout -count=1`
