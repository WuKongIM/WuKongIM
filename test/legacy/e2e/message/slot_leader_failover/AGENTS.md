...
This file is for agents working on `test/legacy/e2e/message/slot_leader_failover`.
...
`go test -tags=e2e,legacy_e2e ./test/legacy/e2e/message/slot_leader_failover -count=1`
