...
This file is for agents working on `test/legacy/e2e/message/single_node_send_message`.
...
1. Start one real node through `test/legacy/e2e/suite`.
...
`go test -tags=e2e,legacy_e2e ./test/legacy/e2e/message/single_node_send_message -count=1`
