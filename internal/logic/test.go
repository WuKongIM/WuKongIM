...
func NewServerOptions() *options.Options {
	opts := options.New()
	opts.Mode = options.TestMode
	opts.UnitTest = true
...
func NewTestServer(ots ...*options.Options) *Logic {
...
func NewTestOptions(logLevel ...zapcore.Level) *options.Options {
	opt := options.New()
	opt.UnitTest = true
