...
func (f fakeObservabilityCluster) SlotLogEntriesOnNode(context.Context, uint64, uint32, raftcluster.SlotLogEntriesOptions) (raftcluster.SlotLogEntries, error) {
	return raftcluster.SlotLogEntries{}, nil
}

func (f fakeObservabilityCluster) ControllerLogEntriesOnNode(context.Context, uint64, raftcluster.ControllerLogEntriesOptions) (raftcluster.ControllerLogEntries, error) {
...
func (f fakeObservabilityCluster) CompactControllerRaftLogOnNode(context.Context, uint64) (raftcluster.ControllerRaftCompactionResult, error) {
