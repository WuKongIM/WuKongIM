...
type ReconnectConfig struct {
	...
	Enabled bool `json:"enabled" yaml:"enabled"`
	// Interval is the base delay between reconnect attempts.
	Interval time.Duration `json:"interval" yaml:"interval"`
	// Jitter is the maximum random delay added to reconnect attempts.
...
type MembersConfig struct {
	...
	Pick string `json:"pick" yaml:"pick"`
	// Overlap controls member reuse across generated channels.
	Overlap float64 `json:"overlap" yaml:"overlap"`
}
