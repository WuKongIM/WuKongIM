...
func FormalConfig() Config {
	return Config{
		...
		Observation: ObservationConfig{
			...
			LoadHostMetrics: EndpointDeclaration{Name: "host-metrics-load", Address: "http://host-metrics-load.invalid", Mountpoint: "/var/lib/wukongim-cloud", Device: "/dev/wukongim-data"},
		...
		Thresholds: ThresholdsConfig{
			...
			Resource: ResourceThresholds{
				...
				HostCPUPercent: 90, HostMemoryPercent: 85, BoundedQueuePercent: 80,
