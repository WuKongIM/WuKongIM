...
func TestObservationRejectsUnusableFormalRoles(t *testing.T) {
	tests := []struct {
		...
		{"API gateway alias", func(c *Config) { c.Observation.GatewayTCPAddrs[0] = c.Observation.APIAddrs[0] }, "observation.gateway_tcp_addrs[0]: aliases observation.api_addrs[0]"},
