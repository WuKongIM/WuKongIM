...
| `access/api.Server` | `access/api/server.go:57` | HTTP API：服务端消息发送、频道消息同步、Token 管理、会话同步、健康检查 |
...
| `Server` | access/api/server.go:57 | HTTP API 服务器：消息发送、频道消息同步、Token、会话同步、健康检查 |
