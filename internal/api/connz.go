...
// func (s *Server) GetConnInfos(uid string, sortOpt SortOpt, offset, limit int) []*reactor.Conn {
// 	connCtxs := make([]*reactor.Conn, 0, s.engine.ConnCount())
...
// func newConnInfo(connCtx *reactor.Conn) *ConnInfo {
// 	var (
// 		now  = time.Now()
// 		host string
// 		port int
...
// func device(connCtx *reactor.Conn) string {
// 	d := "未知"
// 	level := "主"
...
// // byID
// type byID struct{ Conns []*reactor.Conn }
...
// // byIDDesc
// type byIDDesc struct{ Conns []*reactor.Conn }
...
// // inMsg
// type byInMsg struct{ Conns []*reactor.Conn }
...
// type byInMsgDesc struct{ Conns []*reactor.Conn }
...
// type byOutMsg struct{ Conns []*reactor.Conn }
...
// type byOutMsgDesc struct{ Conns []*reactor.Conn }
...
// type byInMsgBytes struct{ Conns []*reactor.Conn }
...
// type byInMsgBytesDesc struct{ Conns []*reactor.Conn }
...
// type byOutMsgBytes struct{ Conns []*reactor.Conn }
...
// type byOutMsgBytesDesc struct{ Conns []*reactor.Conn }
...
// type byOutPacketBytes struct{ Conns []*reactor.Conn }
...
// type byOutPacketBytesDesc struct{ Conns []*reactor.Conn }
...
// type byInPacketBytes struct{ Conns []*reactor.Conn }
...
// type byInPacketBytesDesc struct{ Conns []*reactor.Conn }
...
// type byOutPacket struct{ Conns []*reactor.Conn }
...
// type byOutPacketDesc struct{ Conns []*reactor.Conn }
...
// type byInPacket struct{ Conns []*reactor.Conn }
...
// type byInPacketDesc struct{ Conns []*reactor.Conn }
...
// type byUptime struct{ Conns []*reactor.Conn }
...
// type byUptimeDesc struct{ Conns []*reactor.Conn }
...
// // idle
// type byIdle struct{ Conns []*reactor.Conn }
...
// // idleDesc
// type byIdleDesc struct{ Conns []*reactor.Conn }
...
// // protoVersion
// type byProtoVersion struct{ Conns []*reactor.Conn }
...
// // protoVersionDesc
// type byProtoVersionDesc struct{ Conns []*reactor.Conn }
