...
type Slot struct {
	...
	Peers    []uint64  `protobuf:"varint,4,rep,packed,name=peers,proto3" json:"peers,omitempty"`         // 槽位分配的节点
	WillJoin []uint64  `protobuf:"varint,5,rep,packed,name=willJoin,proto3" json:"willJoin,omitempty"`   // 槽位将要加入的节点
	Joined   []uint64  `protobuf:"varint,6,rep,packed,name=joined,proto3" json:"joined,omitempty"`       // 已经加入的节点
	Learners []uint64  `protobuf:"varint,7,rep,packed,name=learners,proto3" json:"learners,omitempty"`   // 学习者节点
}
...
func (x *Slot) GetWillJoin() []uint64 {
	if x != nil {
		return x.WillJoin
	}
	return nil
...
// slot增加副本节点
type SlotAddReplica struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Slot   uint32 `protobuf:"varint,1,opt,name=slot,proto3" json:"slot,omitempty"`     // 槽位
	PeerID uint64 `protobuf:"varint,2,opt,name=peerID,proto3" json:"peerID,omitempty"` // 节点ID
}

func (x *SlotAddReplica) Reset() {
	*x = SlotAddReplica{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_server_cluster_pb_cluster_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SlotAddReplica) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SlotAddReplica) ProtoMessage() {}

func (x *SlotAddReplica) ProtoReflect() protoreflect.Message {
	mi := &file_internal_server_cluster_pb_cluster_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SlotAddReplica.ProtoReflect.Descriptor instead.
func (*SlotAddReplica) Descriptor() ([]byte, []int) {
	return file_internal_server_cluster_pb_cluster_proto_rawDescGZIP(), []int{10}
}

func (x *SlotAddReplica) GetSlot() uint32 {
	if x != nil {
		return x.Slot
	}
	return 0
...
func (x *SlotAddReplica) GetPeerID() uint64 {
	if x != nil {
		return x.PeerID
	}
	return 0
...
var file_internal_server_cluster_pb_cluster_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_internal_server_cluster_pb_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_internal_server_cluster_pb_cluster_proto_goTypes = []interface{}{
	...
	(*SlotAddReplica)(nil),        // 14: SlotAddReplica
}
...
func file_internal_server_cluster_pb_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_server_cluster_pb_cluster_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SlotAddReplica); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
