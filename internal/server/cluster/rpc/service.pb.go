...
const (
	...
	CMDType_ForwardRecvackPacket CMDType = 8  // 转发接受ack包
	CMDType_GetClusterConfig     CMDType = 9  // 获取集群配置
	CMDType_JoinCluster          CMDType = 10 // 加入集群
	CMDType_UpdateClusterConfig  CMDType = 11 // 更新集群配置
	CMDType_JoinDone             CMDType = 12 // 加入完成
)
...
var (
	CMDType_name = map[int32]string{
		...
		6:  "ConnPing",
		7:  "SendSyncPropose",
		8:  "ForwardRecvackPacket",
		9:  "GetClusterConfig",
		10: "JoinCluster",
		11: "UpdateClusterConfig",
		12: "JoinDone",
	}
	CMDType_value = map[string]int32{
		...
		"ConnPing":             6,
		"SendSyncPropose":      7,
		"ForwardRecvackPacket": 8,
		"GetClusterConfig":     9,
		"JoinCluster":          10,
		"UpdateClusterConfig":  11,
		"JoinDone":             12,
	}
)
...
type ConnectReq struct {
	...
	DeviceFlag        string `protobuf:"bytes,2,opt,name=deviceFlag,proto3" json:"deviceFlag,omitempty"`               // 用户设备标记
...
func (x *ConnectReq) GetDeviceFlag() string {
	if x != nil {
		return x.DeviceFlag
	}
	return ""
...
type ConnectWriteReq struct {
	...
	Uid        string `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"`                // 用户ID
	DeviceFlag uint32 `protobuf:"varint,2,opt,name=deviceFlag,proto3" json:"deviceFlag,omitempty"` // 设备标识
...
func (x *ConnectWriteReq) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
func (x *ConnectCloseReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConnectCloseReq) ProtoMessage() {}

func (x *ConnectCloseReq) ProtoReflect() protoreflect.Message {
	mi := &file_internal_server_cluster_rpc_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConnectCloseReq.ProtoReflect.Descriptor instead.
func (*ConnectCloseReq) Descriptor() ([]byte, []int) {
	return file_internal_server_cluster_rpc_service_proto_rawDescGZIP(), []int{6}
}

func (x *ConnectCloseReq) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *ConnectCloseReq) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
func (x *ConnectCloseReq) GetDeviceFlag() uint32 {
	if x != nil {
		return x.DeviceFlag
	}
	return 0
...
func (x *ConnPingReq) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
type ForwardSendPacketReq struct {
	...
	ToNodeId     uint64 `protobuf:"varint,1,opt,name=toNodeId,proto3" json:"toNodeId,omitempty"`         // 接收节点ID
	SendPackets  []byte `protobuf:"bytes,2,opt,name=sendPackets,proto3" json:"sendPackets,omitempty"`    // 发送包数据集合
	ChannelID    string `protobuf:"bytes,3,opt,name=channelID,proto3" json:"channelID,omitempty"`        // 频道ID
	ChannelType  uint32 `protobuf:"varint,4,opt,name=channelType,proto3" json:"channelType,omitempty"`   // 频道类型
	FromUID      string `protobuf:"bytes,5,opt,name=fromUID,proto3" json:"fromUID,omitempty"`            // 发送者ID
	ProtoVersion uint32 `protobuf:"varint,6,opt,name=protoVersion,proto3" json:"protoVersion,omitempty"` // 协议版本
	DeviceFlag   uint32 `protobuf:"varint,7,opt,name=deviceFlag,proto3" json:"deviceFlag,omitempty"`     // 设备标识
	DeviceID     string `protobuf:"bytes,8,opt,name=deviceID,proto3" json:"deviceID,omitempty"`          // 设备ID
	TraceID      []byte `protobuf:"bytes,9,opt,name=traceID,proto3" json:"traceID,omitempty"`            // traceID（调用链追踪用）
	SpanID       []byte `protobuf:"bytes,10,opt,name=spanID,proto3" json:"spanID,omitempty"`             // spanID （调用链追踪用）
}
...
func (x *ForwardSendPacketReq) GetToNodeId() uint64 {
	if x != nil {
		return x.ToNodeId
	}
	return 0
...
func (x *ForwardSendPacketReq) GetTraceID() []byte {
	if x != nil {
		return x.TraceID
	}
	return nil
...
func (x *ForwardSendPacketReq) GetSpanID() []byte {
	if x != nil {
		return x.SpanID
	}
	return nil
...
func (x *ForwardRecvPacketReq) GetTraceID() []byte {
	if x != nil {
		return x.TraceID
	}
	return nil
...
func (x *ForwardRecvPacketReq) GetSpanID() []byte {
	if x != nil {
		return x.SpanID
	}
	return nil
...
func (x *SendSyncProposeResp) Reset() {
	*x = SendSyncProposeResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_server_cluster_rpc_service_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendSyncProposeResp) Descriptor() ([]byte, []int) {
	return file_internal_server_cluster_rpc_service_proto_rawDescGZIP(), []int{16}
}
...
func (x *RecvacksReq) Reset() {
	*x = RecvacksReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_server_cluster_rpc_service_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RecvacksReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecvacksReq) ProtoMessage() {}

func (x *RecvacksReq) ProtoReflect() protoreflect.Message {
	mi := &file_internal_server_cluster_rpc_service_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RecvacksReq.ProtoReflect.Descriptor instead.
func (*RecvacksReq) Descriptor() ([]byte, []int) {
	return file_internal_server_cluster_rpc_service_proto_rawDescGZIP(), []int{17}
}

func (x *RecvacksReq) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *RecvacksReq) GetDeviceId() string {
	if x != nil {
		return x.DeviceId
	}
	return ""
...
func (x *RecvacksReq) GetBelongPeerID() uint64 {
	if x != nil {
		return x.BelongPeerID
	}
	return 0
...
func (x *RecvacksReq) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_internal_server_cluster_rpc_service_proto_rawDesc = []byte{
	...
	,
	...
	0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0a, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x22,
	0x73, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x57, 0x72, 0x69, 0x74, 0x65, 0x52,
	...
	0x61, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65,
	0x46, 0x6c, 0x61, 0x67, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64,
	...
	,
	...
	,
	...
	0x70, 0x61, 0x6e, 0x49, 0x44, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x73, 0x70, 0x61,
	0x6e, 0x49, 0x44, 0x22, 0x53, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72,
	0x69, 0x62, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x68, 0x61, 0x6e,
	...
	0x6c, 0x54, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x63, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x22, 0x36, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x53,
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x20,
	...
	0x22, 0x59, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x53, 0x65, 0x71, 0x52, 0x65, 0x71, 0x12, 0x1c, 0x0a, 0x09, 0x63,
	...
	0x6e, 0x6e, 0x65, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x22, 0x3a, 0x0a, 0x18, 0x47,
	0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x53, 0x65, 0x71, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1e, 0x0a, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x53, 0x65, 0x71, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x53, 0x65, 0x71, 0x22, 0x3c, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64, 0x53,
	0x79, 0x6e, 0x63, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x3d, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x79, 0x6e,
	0x63, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x12, 0x0a, 0x04,
	0x73, 0x6c, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x6c, 0x6f, 0x74,
	0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x22, 0x73, 0x0a, 0x0b, 0x52, 0x65, 0x63, 0x76, 0x61, 0x63, 0x6b, 0x73,
	...
	,
...
var file_internal_server_cluster_rpc_service_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_internal_server_cluster_rpc_service_proto_goTypes = []interface{}{
	...
	(*ConnectCloseReq)(nil),          // 8: rpc.ConnectCloseReq
	(*ConnPingReq)(nil),              // 9: rpc.ConnPingReq
	(*ForwardSendPacketReq)(nil),     // 10: rpc.ForwardSendPacketReq
	(*ForwardSendPacketResp)(nil),    // 11: rpc.ForwardSendPacketResp
	(*ForwardRecvPacketReq)(nil),     // 12: rpc.ForwardRecvPacketReq
	(*GetSubscribersReq)(nil),        // 13: rpc.GetSubscribersReq
	(*GetSubscribersResp)(nil),       // 14: rpc.GetSubscribersResp
	(*GetChannelMessageSeqReq)(nil),  // 15: rpc.GetChannelMessageSeqReq
	(*GetChannelMessageSeqResp)(nil), // 16: rpc.GetChannelMessageSeqResp
	(*SendSyncProposeReq)(nil),       // 17: rpc.SendSyncProposeReq
	(*SendSyncProposeResp)(nil),      // 18: rpc.SendSyncProposeResp
	(*RecvacksReq)(nil),              // 19: rpc.RecvacksReq
}
...
func file_internal_server_cluster_rpc_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_server_cluster_rpc_service_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internal_server_cluster_rpc_service_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RecvacksReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
