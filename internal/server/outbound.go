...
func NewOutbound(writer OutBoundWriter, opts *OutboundOptions, s *Server) *Outbound {
...
func (o *Outbound) flushOutbound() bool {
	...
	o.writer.SetWriteDeadline(start.Add(writeDeadline))
