...
var schemaFields = []fieldSpec{
	...
	{TOMLPath: "backup.provider", EnvKey: "WK_BACKUP_PROVIDER", Kind: kindString, Group: "backup", Label: "Backup provider", Description: "Qualified external durability adapter. The supported value is aliyun for OSS and RAM STS."},
