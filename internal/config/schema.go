...
var schemaFields = []fieldSpec{
	...
	{TOMLPath: "backup.target_segment_bytes", EnvKey: "WK_BACKUP_TARGET_SEGMENT_BYTES", Kind: kindUint64, Group: "backup", Label: "Target segment bytes", Description: "Ordinary plaintext rolling target for one continuous-capture segment."},
	{TOMLPath: "backup.max_segment_bytes", EnvKey: "WK_BACKUP_MAX_SEGMENT_BYTES", Kind: kindUint64, Group: "backup", Label: "Maximum segment bytes", Description: "Hard plaintext ceiling for one continuous-capture segment; it must be at least the rolling target and no greater than the portable 256 MiB limit."},
