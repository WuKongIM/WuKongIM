...
var schemaFields = []fieldSpec{
	...
	{TOMLPath: "backup.enabled", EnvKey: "WK_BACKUP_ENABLED", Kind: kindBool, Group: "backup", Label: "Backup enabled", Description: "Starts automatic cluster-semantic backup only after all repository, key, staging, and policy checks pass."},
	{TOMLPath: "backup.provider", EnvKey: "WK_BACKUP_PROVIDER", Kind: kindString, Group: "backup", Label: "Backup provider", Description: "Qualified external durability adapter. The supported value is aliyun for OSS, KMS, and RAM STS."},
	{TOMLPath: "backup.qualification_gate", EnvKey: "WK_BACKUP_QUALIFICATION_GATE", Kind: kindString, Group: "backup", Label: "Production qualification gate", Description: "Exact versioned release qualification identity required before automatic backup can start; this prevents an older drill attestation from enabling a changed implementation."},
	{TOMLPath: "backup.restore_mode", EnvKey: "WK_BACKUP_RESTORE_MODE", Kind: kindBool, Group: "backup", Label: "Restore mode", Description: "Starts a fresh cluster with ordinary traffic and side effects disabled for an explicit wkcli recovery workflow."},
	{TOMLPath: "backup.repository_id", EnvKey: "WK_BACKUP_REPOSITORY_ID", Kind: kindString, Group: "backup", Label: "Repository identity", Description: "Stable logical identity embedded in checkpoint catalogs and shared by the independently verified primary and secondary repositories."},
	{TOMLPath: "backup.source_generation", EnvKey: "WK_BACKUP_SOURCE_GENERATION", Kind: kindString, Group: "backup", Label: "Source generation", Description: "Stable disaster-recovery generation for this source cluster incarnation; restored successors must use a new value before backup is enabled."},
	{TOMLPath: "backup.target_generation", EnvKey: "WK_BACKUP_TARGET_GENERATION", Kind: kindString, Group: "backup", Label: "Restore target generation", Description: "Fresh successor-cluster generation required only in restore mode; it must differ from the selected checkpoint source generation."},
	{TOMLPath: "backup.staging_dir", EnvKey: "WK_BACKUP_STAGING_DIR", Kind: kindString, Group: "backup", Label: "Staging directory", Description: "Node-local directory for bounded temporary backup data; it must not be a repository or application data path."},
	{TOMLPath: "backup.kms_key_id", EnvKey: "WK_BACKUP_KMS_KEY_ID", Kind: kindString, Group: "backup", Label: "KMS encryption key", Description: "External KMS key identifier used to wrap the unique data key generated for each encrypted object."},
	{TOMLPath: "backup.signing_key_id", EnvKey: "WK_BACKUP_SIGNING_KEY_ID", Kind: kindString, Group: "backup", Label: "Artifact signing key", Description: "External asymmetric KMS key identifier used to sign checkpoint catalogs and immutable backup artifacts."},
	{TOMLPath: "backup.trusted_signing_key_ids", EnvKey: "WK_BACKUP_TRUSTED_SIGNING_KEY_IDS", Kind: kindStringList, Group: "backup", Label: "Previous artifact signing keys", Description: "Retained previous asymmetric KMS key identifiers accepted only when verifying historical checkpoints and backup artifacts; the active signing key is always trusted automatically."},
	{TOMLPath: "backup.kms_region", EnvKey: "WK_BACKUP_KMS_REGION", Kind: kindString, Group: "backup", Label: "KMS region", Description: "Provider region for envelope-key and manifest-signing KMS calls."},
	{TOMLPath: "backup.kms_endpoint", EnvKey: "WK_BACKUP_KMS_ENDPOINT", Kind: kindString, Group: "backup", Label: "KMS endpoint", Description: "Optional provider KMS HTTPS API origin; empty uses the provider regional endpoint.", Sensitive: true},
	{TOMLPath: "backup.kms_role_arn", EnvKey: "WK_BACKUP_KMS_ROLE_ARN", Kind: kindString, Group: "backup", Label: "KMS role", Description: "Separately assumed Alibaba RAM role allowed to generate and unwrap data keys and sign or verify backup artifacts.", Sensitive: true},
	{TOMLPath: "backup.capture_reconcile_interval", EnvKey: "WK_BACKUP_CAPTURE_RECONCILE_INTERVAL", Kind: kindDuration, Group: "backup", Label: "Capture reconcile interval", Description: "Correctness poll for every Hash Slot when non-blocking commit wake hints are lost; it must be positive and no longer than the checkpoint interval."},
	{TOMLPath: "backup.checkpoint_interval", EnvKey: "WK_BACKUP_CHECKPOINT_INTERVAL", Kind: kindDuration, Group: "backup", Label: "Checkpoint interval", Description: "Cadence for publishing the latest complete durable cross-repository Slot frontier as a cluster checkpoint."},
	{TOMLPath: "backup.baseline_chunk_bytes", EnvKey: "WK_BACKUP_BASELINE_CHUNK_BYTES", Kind: kindUint64, Group: "backup", Label: "Baseline chunk bytes", Description: "Maximum plaintext bytes read into one materialized replacement-baseline object; allowed range is 1 MiB through 256 MiB."},
	{TOMLPath: "backup.target_segment_bytes", EnvKey: "WK_BACKUP_TARGET_SEGMENT_BYTES", Kind: kindUint64, Group: "backup", Label: "Target segment bytes", Description: "Ordinary plaintext rolling target for one continuous-capture segment; the hard per-segment limit remains 256 MiB."},
	{TOMLPath: "backup.max_segment_open_duration", EnvKey: "WK_BACKUP_MAX_SEGMENT_OPEN_DURATION", Kind: kindDuration, Group: "backup", Label: "Max segment open duration", Description: "Maximum time a sparse non-empty capture segment may remain only in node memory before it is sealed durably."},
	{TOMLPath: "backup.staging_max_bytes", EnvKey: "WK_BACKUP_STAGING_MAX_BYTES", Kind: kindUint64, Group: "backup", Label: "Staging quota bytes", Description: "Hard node-local byte quota for backup staging so capture yields before threatening the message data volume."},
	{TOMLPath: "backup.worker_count", EnvKey: "WK_BACKUP_WORKER_COUNT", Kind: kindInt, Group: "backup", Label: "Worker count", Description: "Maximum Hash Slot capture or restore partitions processed concurrently on one node."},
	{TOMLPath: "backup.source_pin_max_age", EnvKey: "WK_BACKUP_SOURCE_PIN_MAX_AGE", Kind: kindDuration, Group: "backup", Label: "Source pin max age", Description: "Hard lifetime of one Hash Slot Raft-log compaction hold before only that Slot builds a replacement materialized baseline."},
	{TOMLPath: "backup.max_source_pinned_bytes", EnvKey: "WK_BACKUP_MAX_SOURCE_PINNED_BYTES", Kind: kindUint64, Group: "backup", Label: "Source pin byte budget", Description: "Hard aggregate estimate of Slot Raft-log bytes backup may retain on one node before one deterministic victim Slot rebases."},
	{TOMLPath: "backup.audit_interval", EnvKey: "WK_BACKUP_AUDIT_INTERVAL", Kind: kindDuration, Group: "backup", Label: "Audit step interval", Description: "Cadence for one bounded Controller-Leader integrity audit or repair transition."},
	{TOMLPath: "backup.audit_scrub_interval", EnvKey: "WK_BACKUP_AUDIT_SCRUB_INTERVAL", Kind: kindDuration, Group: "backup", Label: "Audit scrub interval", Description: "Maximum interval before retained checkpoint graphs receive a full authenticated scrub even without new publications."},
	{TOMLPath: "backup.garbage_collection_interval", EnvKey: "WK_BACKUP_GARBAGE_COLLECTION_INTERVAL", Kind: kindDuration, Group: "backup", Label: "Generation GC interval", Description: "Cadence for one bounded Controller-Leader Generation retention and repository sweep step."},
	{TOMLPath: "backup.garbage_safety_window", EnvKey: "WK_BACKUP_GARBAGE_SAFETY_WINDOW", Kind: kindDuration, Group: "backup", Label: "Generation GC safety window", Description: "Minimum age of unreferenced immutable attempts before the restricted collector may delete them; it must be at least seven days."},
	{TOMLPath: "backup.garbage_max_requests_per_repository", EnvKey: "WK_BACKUP_GARBAGE_MAX_REQUESTS_PER_REPOSITORY", Kind: kindInt, Group: "backup", Label: "Generation GC request budget", Description: "Maximum provider requests consumed by one repository in one bounded Generation sweep step."},
	{TOMLPath: "backup.garbage_max_bytes_per_repository", EnvKey: "WK_BACKUP_GARBAGE_MAX_BYTES_PER_REPOSITORY", Kind: kindUint64, Group: "backup", Label: "Generation GC byte budget", Description: "Maximum stored bytes deleted from one repository in one bounded Generation sweep step."},
	{TOMLPath: "backup.retention_monthly_months", EnvKey: "WK_BACKUP_RETENTION_MONTHLY_MONTHS", Kind: kindInt, Group: "backup", Label: "Monthly checkpoint retention", Description: "Number of months retaining one sparse monthly checkpoint in addition to fixed recent, hourly, and daily tiers; zero disables the monthly tier."},
	{TOMLPath: "backup.object_lock_days", EnvKey: "WK_BACKUP_OBJECT_LOCK_DAYS", Kind: kindInt, Group: "backup", Label: "Object lock days", Description: "Minimum compliance-mode retention applied to every repository object; production backup requires at least seven days."},
	{TOMLPath: "backup.primary.endpoint", EnvKey: "WK_BACKUP_PRIMARY_ENDPOINT", Kind: kindString, Group: "backup", Label: "Primary endpoint", Description: "Provider-native HTTPS object-storage API origin for the primary repository.", Sensitive: true},
	{TOMLPath: "backup.primary.region", EnvKey: "WK_BACKUP_PRIMARY_REGION", Kind: kindString, Group: "backup", Label: "Primary region", Description: "Signing or provider region for the primary repository."},
	{TOMLPath: "backup.primary.bucket", EnvKey: "WK_BACKUP_PRIMARY_BUCKET", Kind: kindString, Group: "backup", Label: "Primary bucket", Description: "Versioned and Object-Lock-enabled bucket for the primary repository."},
	{TOMLPath: "backup.primary.prefix", EnvKey: "WK_BACKUP_PRIMARY_PREFIX", Kind: kindString, Group: "backup", Label: "Primary prefix", Description: "Dedicated immutable object namespace for this repository identity in the primary bucket."},
	{TOMLPath: "backup.primary.access_role_arn", EnvKey: "WK_BACKUP_PRIMARY_ACCESS_ROLE_ARN", Kind: kindString, Group: "backup", Label: "Primary access role", Description: "Separately assumed Alibaba RAM role allowed ordinary capture and restore reads or writes in the primary repository.", Sensitive: true},
	{TOMLPath: "backup.primary.repair_role_arn", EnvKey: "WK_BACKUP_PRIMARY_REPAIR_ROLE_ARN", Kind: kindString, Group: "backup", Label: "Primary repair role", Description: "Separately assumed least-privilege role allowed to publish authenticated repair versions in the primary repository.", Sensitive: true},
	{TOMLPath: "backup.primary.garbage_role_arn", EnvKey: "WK_BACKUP_PRIMARY_GARBAGE_ROLE_ARN", Kind: kindString, Group: "backup", Label: "Primary garbage role", Description: "Separately assumed least-privilege role allowed to delete expired versions in the primary repository.", Sensitive: true},
	{TOMLPath: "backup.secondary.endpoint", EnvKey: "WK_BACKUP_SECONDARY_ENDPOINT", Kind: kindString, Group: "backup", Label: "Secondary endpoint", Description: "Provider-native HTTPS object-storage API origin for the independently verified cross-region repository.", Sensitive: true},
	{TOMLPath: "backup.secondary.region", EnvKey: "WK_BACKUP_SECONDARY_REGION", Kind: kindString, Group: "backup", Label: "Secondary region", Description: "Signing or provider region for the secondary repository."},
	{TOMLPath: "backup.secondary.bucket", EnvKey: "WK_BACKUP_SECONDARY_BUCKET", Kind: kindString, Group: "backup", Label: "Secondary bucket", Description: "Versioned and Object-Lock-enabled bucket whose verified watermark determines effective RPO."},
	{TOMLPath: "backup.secondary.prefix", EnvKey: "WK_BACKUP_SECONDARY_PREFIX", Kind: kindString, Group: "backup", Label: "Secondary prefix", Description: "Dedicated immutable object namespace for this repository identity in the secondary bucket."},
	{TOMLPath: "backup.secondary.access_role_arn", EnvKey: "WK_BACKUP_SECONDARY_ACCESS_ROLE_ARN", Kind: kindString, Group: "backup", Label: "Secondary access role", Description: "Separately assumed Alibaba RAM role allowed ordinary capture and restore reads or writes in the secondary repository.", Sensitive: true},
	{TOMLPath: "backup.secondary.repair_role_arn", EnvKey: "WK_BACKUP_SECONDARY_REPAIR_ROLE_ARN", Kind: kindString, Group: "backup", Label: "Secondary repair role", Description: "Separately assumed least-privilege role allowed to publish authenticated repair versions in the secondary repository.", Sensitive: true},
	{TOMLPath: "backup.secondary.garbage_role_arn", EnvKey: "WK_BACKUP_SECONDARY_GARBAGE_ROLE_ARN", Kind: kindString, Group: "backup", Label: "Secondary garbage role", Description: "Separately assumed least-privilege role allowed to delete expired versions in the secondary repository.", Sensitive: true},
...
func supportedConfigKeysForBuilder() []string {
	return []string{
		...
		"WK_BACKUP_SOURCE_PIN_MAX_AGE",
		"WK_BACKUP_MAX_SOURCE_PINNED_BYTES",
