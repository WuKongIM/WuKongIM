...
var schemaFields = []fieldSpec{
	...
	{TOMLPath: "backup.kms_region", EnvKey: "WK_BACKUP_KMS_REGION", Kind: kindString, Group: "backup", Label: "KMS region", Description: "AWS-compatible signing region for envelope-key and manifest-signing KMS calls."},
	{TOMLPath: "backup.kms_endpoint", EnvKey: "WK_BACKUP_KMS_ENDPOINT", Kind: kindString, Group: "backup", Label: "KMS endpoint", Description: "Optional HTTPS KMS-compatible API origin; empty uses the AWS regional endpoint.", Sensitive: true},
	...
	{TOMLPath: "backup.primary.endpoint", EnvKey: "WK_BACKUP_PRIMARY_ENDPOINT", Kind: kindString, Group: "backup", Label: "Primary endpoint", Description: "HTTPS API origin for the primary S3-compatible repository.", Sensitive: true},
	...
	{TOMLPath: "backup.secondary.endpoint", EnvKey: "WK_BACKUP_SECONDARY_ENDPOINT", Kind: kindString, Group: "backup", Label: "Secondary endpoint", Description: "HTTPS API origin for the independently verified cross-region S3-compatible repository.", Sensitive: true},
