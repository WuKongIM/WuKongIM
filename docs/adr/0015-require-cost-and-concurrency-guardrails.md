...
ADR 0041 records the PostPaid topology and longer immutable Lease expiries for the separately bounded automated chat-lifecycle flow; its aggregate Cost Envelope and single-run guard remain mandatory.
