...
ADR 0046 records the automated chat-lifecycle flow's scoped two-tier policy, which reports attributable hardware saturation as a capacity warning while retaining insufficient_evidence for ambiguous attribution.
