...
ADR 0041 records the 12-hour rehearsal and 96-hour formal Cloud Lease AutoRelease expiries for the automated chat-lifecycle flow while preserving the distinction between billable Lease time and post-readiness workload time. Rehearsal normally releases far earlier; the ceiling exists to contain a same-Lease deployment-repair window.
