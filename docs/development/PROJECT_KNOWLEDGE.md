...
- wkbench warmup records typed session-operation failures and continues, while timed measurements continue individual message failures; configured error-rate limits decide the verdict, phase cancellation is excluded from error counters, and structural harness failures remain fail-fast.
