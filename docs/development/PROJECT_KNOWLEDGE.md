...
- The manual-only `Backup qualification / Backup release gate` produces commit-bound repository evidence from contract, race, and three-process restore/failure tests; it is not a branch-protection check and never substitutes for real S3/KMS/Object Lock/IAM and 1 TB production qualification.
