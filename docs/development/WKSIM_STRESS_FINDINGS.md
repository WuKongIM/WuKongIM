...
- Repeat the 10k activation once more to distinguish the remaining two-node leader distribution skew from random placement variance, then consider tightening the stable p99 gate below 500ms for the local three-node cardinality proof.
