...
| [docs-site/FLOW.md](../../docs-site/FLOW.md) | `subtree` | Owns the bilingual static v3 documentation site, shared navigation, publication state, search, SEO, and machine-readable outputs. | 103 | warning |
| [internal/access/api/FLOW.md](../../internal/access/api/FLOW.md) | `package` | Adapts product, benchmark, debug, and compatibility HTTP requests to internal use cases. | 126 | warning |
...
| [internal/access/gateway/FLOW.md](../../internal/access/gateway/FLOW.md) | `package` | Maps gateway sessions and frames to message, presence, and delivery usecases without owning authority or durable-send policy. | 72 | ok |
...
| [internal/access/manager/FLOW.md](../../internal/access/manager/FLOW.md) | `package` | Adapts authenticated Manager HTTP and UI operations to bounded management use cases. | 84 | ok |
| [internal/access/node/FLOW.md](../../internal/access/node/FLOW.md) | `package` | Adapts versioned node RPC frames to local authority, runtime, and management ports. | 98 | ok |
...
| [internal/app/FLOW.md](../../internal/app/FLOW.md) | `package` | Composes product and Agent runtimes and owns their dependency-safe lifecycle ordering. | 107 | warning |
| [internal/bench/FLOW.md](../../internal/bench/FLOW.md) | `subtree` | Implements deterministic black-box benchmark planning, workers, traffic, and evidence. | 102 | warning |
...
| [internal/infra/cluster/FLOW.md](../../internal/infra/cluster/FLOW.md) | `package` | Adapts internal ports to cluster, channel, metadata, node-RPC, and operations runtimes without owning business policy. | 109 | warning |
| [internal/infra/delivery/FLOW.md](../../internal/infra/delivery/FLOW.md) | `package` | Adapts presence lookup and owner-local session writes for canonical online delivery. | 51 | ok |
...
| [internal/runtime/channelappend/FLOW.md](../../internal/runtime/channelappend/FLOW.md) | `package` | Owns routed local Channel append admission, ordered durable writes, item futures, and bounded post-commit delivery handoff. | 97 | ok |
...
| [internal/runtime/messageupdates/FLOW.md](../../internal/runtime/messageupdates/FLOW.md) | `package` | Schedules bounded message-edit notification repair and retention cleanup through injected source and dispatcher ports. | 44 | ok |
| [internal/runtime/online/FLOW.md](../../internal/runtime/online/FLOW.md) | `package` | Maintains node-local pending and active connection routes, concrete session handles, and bounded touch batching. | 51 | ok |
...
| [internal/runtime/readavailability/FLOW.md](../../internal/runtime/readavailability/FLOW.md) | `package` | Classifies typed transient failures of authority-routed reads without HTTP or retry scheduling policy. | 42 | ok |
...
| [internal/usecase/conversation/FLOW.md](../../internal/usecase/conversation/FLOW.md) | `package` | Builds transient conversations from UID membership and Channel state, and owns badge, hide, and activation commands. | 96 | ok |
...
| [internal/usecase/message/FLOW.md](../../internal/usecase/message/FLOW.md) | `package` | Owns entry-independent message permission policy, send orchestration, committed sync, and message-event projection contracts. | 106 | warning |
...
| [internal/usecase/plugin/FLOW.md](../../internal/usecase/plugin/FLOW.md) | `package` | Owns entry-independent plugin desired state, candidate selection, hook orchestration, and PDK-compatible host RPC mapping. | 75 | ok |
...
| [pkg/channel/FLOW.md](../../pkg/channel/FLOW.md) | `subtree` | Implements the reusable multi-reactor Channel log runtime, replication, persistence ports, transport, services, and bounded workers. | 111 | warning |
...
| [pkg/cluster/FLOW.md](../../pkg/cluster/FLOW.md) | `subtree` | Composes Controller state, Slot Multi-Raft metadata, typed node RPC, routing, and replicated Channel runtimes behind Node. | 120 | warning |
...
| [pkg/db/message/FLOW.md](../../pkg/db/message/FLOW.md) | `package` | Stores Channel message logs, indexes, checkpoints, retention state, snapshots, and compatibility leases on the shared DB engine. | 120 | warning |
| [pkg/db/meta/FLOW.md](../../pkg/db/meta/FLOW.md) | `package` | Owns Hash-Slot-scoped metadata tables, deterministic batches, membership directories, snapshots, restore, and cache invalidation. | 80 | ok |
...
| [pkg/goroutine/FLOW.md](../../pkg/goroutine/FLOW.md) | `package` | Tracks first-party goroutine ownership, fixed task labels, pool pressure, panics, health, metrics, and bounded shutdown evidence. | 68 | ok |
...
| [pkg/slot/FLOW.md](../../pkg/slot/FLOW.md) | `subtree` | Implements Multi-Raft Slot metadata, atomic FSM commands, authoritative leader reads, snapshots, and distributed metadata proxies. | 97 | ok |
