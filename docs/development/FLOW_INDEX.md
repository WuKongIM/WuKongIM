...
| [internal/runtime/messageupdates/FLOW.md](../../internal/runtime/messageupdates/FLOW.md) | `package` | Schedules bounded message-edit notification repair and retention cleanup through injected source and dispatcher ports. | 59 | ok |
...
| [pkg/db/meta/FLOW.md](../../pkg/db/meta/FLOW.md) | `package` | Owns Hash-Slot-scoped metadata tables, deterministic batches, membership directories, snapshots, restore, and cache invalidation. | 84 | ok |
