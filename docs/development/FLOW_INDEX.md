...
| [internal/access/api/FLOW.md](../../internal/access/api/FLOW.md) | `package` | Adapts product, benchmark, debug, and compatibility HTTP requests to internal use cases. | 116 | warning |
...
| [internal/app/FLOW.md](../../internal/app/FLOW.md) | `package` | Composes product and Agent runtimes and owns their dependency-safe lifecycle ordering. | 101 | warning |
...
| [internal/infra/cluster/FLOW.md](../../internal/infra/cluster/FLOW.md) | `package` | Adapts internal ports to cluster, channel, metadata, node-RPC, and operations runtimes without owning business policy. | 104 | warning |
...
| [internal/usecase/conversation/FLOW.md](../../internal/usecase/conversation/FLOW.md) | `package` | Builds transient conversations from UID membership and Channel state, and owns badge, hide, and activation commands. | 86 | ok |
...
| [internal/usecase/message/FLOW.md](../../internal/usecase/message/FLOW.md) | `package` | Owns entry-independent message permission policy, send orchestration, committed sync, and message-event projection contracts. | 97 | ok |
...
| [pkg/cluster/FLOW.md](../../pkg/cluster/FLOW.md) | `subtree` | Composes Controller state, Slot Multi-Raft metadata, typed node RPC, routing, and replicated Channel runtimes behind Node. | 109 | warning |
...
| [pkg/db/message/FLOW.md](../../pkg/db/message/FLOW.md) | `package` | Stores Channel message logs, indexes, checkpoints, retention state, snapshots, and compatibility leases on the shared DB engine. | 112 | warning |
| [pkg/db/meta/FLOW.md](../../pkg/db/meta/FLOW.md) | `package` | Owns Hash-Slot-scoped metadata tables, deterministic batches, membership directories, snapshots, restore, and cache invalidation. | 76 | ok |
