...
| [internal/bench/chatlifecycle/FLOW.md](../../internal/bench/chatlifecycle/FLOW.md) | `package` | Runs the fenced chat-lifecycle workload, evidence pipeline, and aged-data capacity proof. | 99 | ok |
...
| [internal/usecase/clouddeploy/FLOW.md](../../internal/usecase/clouddeploy/FLOW.md) | `package` | Seals provider-neutral offline deployment bundles, exact Lease plans, host files, and typed readiness receipts. | 65 | ok |
