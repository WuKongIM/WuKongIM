...
| [internal/access/api/FLOW.md](../../internal/access/api/FLOW.md) | `package` | Adapts product, benchmark, debug, and compatibility HTTP requests to internal use cases. | 112 | warning |
...
| [internal/usecase/message/FLOW.md](../../internal/usecase/message/FLOW.md) | `package` | Owns entry-independent message permission policy, send orchestration, committed sync, and message-event projection contracts. | 95 | ok |
