...
func defaultMetricQueries() map[string]string {
	queries := map[string]string{
		...
		"conversation_active_dirty_queue_rows":                    `wukongim_conversation_active_cache_dirty_queue_rows{job="wukongim"}`,
		"conversation_active_dirty_age_buckets":                   `wukongim_conversation_active_cache_dirty_age_buckets{job="wukongim"}`,
		...
		"conversation_active_cache_lock_p99":                      `histogram_quantile(0.99, sum by (instance, node_name, result, phase, le) (rate(wukongim_conversation_active_cache_lock_duration_seconds_bucket{job="wukongim"}[1m])))`,
