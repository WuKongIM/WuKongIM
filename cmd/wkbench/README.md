...
| `metrics classify` | Compares before/after Prometheus snapshots and prints gateway, ChannelV2, and storage attribution hints. |
...
The per-node classification files include ChannelV2 cold-activation stage p99s:
`channelv2_meta_resolve_p99_seconds`, `channelv2_meta_apply_p99_seconds`, and
`channelv2_runtime_append_p99_seconds`. Use them to separate metadata
resolution, runtime create/apply, and append wait before looking at pprof.
