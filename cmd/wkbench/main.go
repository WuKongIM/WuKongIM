...
func printWukongIMAttribution(w io.Writer, report benchmetrics.WukongIMAttribution) {
	...
	printLabeledFloatMap(w, "channelv2_worker_inflight", "pool", report.ChannelRuntimeWorkerInflightByPool, "%.0f")
	printLabeledFloatMap(w, "channelv2_worker_inflight_peak", "pool", report.ChannelRuntimeWorkerInflightPeakByPool, "%.0f")
	...
	printLabeledFloatMap(w, "channelv2_worker_task_p99_seconds", "kind", report.ChannelRuntimeWorkerTaskP99SecondsByKind, "%.6f")
