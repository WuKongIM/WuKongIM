...
start_node() {
  ...
  while IFS= read -r exported_name; do
    case "$exported_name" in
      WK_WUKONGIM_THREE_NODES_*|WK_WKCLI_SIM_THREE_SMOKE_*|WK_BENCH_PRESENCE_*|WK_PROMETHEUS_SOURCE_REF|WK_PROMETHEUS_EMBED_VERSION|WK_PROMETHEUS_REPO|WK_PROMETHEUS_EMBED_DIR)
