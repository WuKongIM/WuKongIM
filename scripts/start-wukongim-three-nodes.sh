  ...
  while IFS= read -r exported_name; do
    case "$exported_name" in
      WK_BENCH_API_ENABLE|WK_BENCH_API_MAX_BATCH_SIZE|WK_BENCH_API_MAX_PAYLOAD_BYTES)
        ;;
      WK_WUKONGIM_THREE_NODES_*|WK_WKCLI_SIM_THREE_SMOKE_*|WK_BENCH_*|WK_PROMETHEUS_SOURCE_REF|WK_PROMETHEUS_EMBED_VERSION|WK_PROMETHEUS_REPO|WK_PROMETHEUS_EMBED_DIR)
