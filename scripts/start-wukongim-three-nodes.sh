...
BIN_PATH="$(env_with_legacy WK_WUKONGIM_THREE_NODES_BIN WK_WUKONGIMV2_THREE_NODES_BIN "$ROOT_DIR/data/wukongim-three-nodes/wukongim")"
LOG_DIR="$(env_with_legacy WK_WUKONGIM_THREE_NODES_LOG_DIR WK_WUKONGIMV2_THREE_NODES_LOG_DIR "$ROOT_DIR/data/wukongim-three-node-logs")"
READY_TIMEOUT="$(env_with_legacy WK_WUKONGIM_THREE_NODES_READY_TIMEOUT WK_WUKONGIMV2_THREE_NODES_READY_TIMEOUT "60")"
POLL_INTERVAL="$(env_with_legacy WK_WUKONGIM_THREE_NODES_POLL_INTERVAL WK_WUKONGIMV2_THREE_NODES_POLL_INTERVAL "1")"
PROMETHEUS_ENABLE="$(env_with_legacy WK_WUKONGIM_THREE_NODES_PROMETHEUS_ENABLE WK_WUKONGIMV2_THREE_NODES_PROMETHEUS_ENABLE "${WK_PROMETHEUS_ENABLE:-true}")"
PROMETHEUS_LISTEN_ADDR="$(env_with_legacy WK_WUKONGIM_THREE_NODES_PROMETHEUS_LISTEN_ADDR WK_WUKONGIMV2_THREE_NODES_PROMETHEUS_LISTEN_ADDR "${WK_PROMETHEUS_LISTEN_ADDR:-127.0.0.1:9091}")"
PROMETHEUS_DATA_DIR="$(env_with_legacy WK_WUKONGIM_THREE_NODES_PROMETHEUS_DATA_DIR WK_WUKONGIMV2_THREE_NODES_PROMETHEUS_DATA_DIR "$ROOT_DIR/data/wukongim-three-nodes/prometheus")"
PROMETHEUS_RETENTION_TIME="$(env_with_legacy WK_WUKONGIM_THREE_NODES_PROMETHEUS_RETENTION_TIME WK_WUKONGIMV2_THREE_NODES_PROMETHEUS_RETENTION_TIME "360h")"
PROMETHEUS_RETENTION_SIZE="$(env_with_legacy WK_WUKONGIM_THREE_NODES_PROMETHEUS_RETENTION_SIZE WK_WUKONGIMV2_THREE_NODES_PROMETHEUS_RETENTION_SIZE "")"
PROMETHEUS_SCRAPE_INTERVAL="$(env_with_legacy WK_WUKONGIM_THREE_NODES_PROMETHEUS_SCRAPE_INTERVAL WK_WUKONGIMV2_THREE_NODES_PROMETHEUS_SCRAPE_INTERVAL "15s")"
...
PID_DIR="$(env_with_legacy WK_WUKONGIM_THREE_NODES_PID_DIR WK_WUKONGIMV2_THREE_NODES_PID_DIR "")"
ALLOW_NODE_EXIT="$(env_with_legacy WK_WUKONGIM_THREE_NODES_ALLOW_NODE_EXIT WK_WUKONGIMV2_THREE_NODES_ALLOW_NODE_EXIT "")"
BUILD=1
CLEAN=0
DRY_RUN=0
EXIT_AFTER_READY=0
