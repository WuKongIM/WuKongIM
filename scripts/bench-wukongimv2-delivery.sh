...
START_CLUSTER=1
CLEAN_CLUSTER=1
START_SCRIPT="$ROOT_DIR/scripts/start-wukongimv2-three-nodes.sh"
...
usage() {
  cat <<'USAGE'
Usage: scripts/bench-wukongimv2-delivery.sh [options]

Runs delivery-focused wkbench traffic against a local cmd/wukongimv2 three-node cluster.
