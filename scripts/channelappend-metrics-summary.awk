...

{
  ...
  if (phase != "before") {
    if (name == "wukongim_channelappend_writer_admission_depth") {
      mailbox_depth_max = max_value(mailbox_depth_max, value)
    } else if (name == "wukongim_channelappend_writer_admission_capacity") {
      mailbox_capacity_max = max_value(mailbox_capacity_max, value)
    } else if (name == "wukongim_channelappend_writer_pool_running") {
      effect_slots_max = max_value(effect_slots_max, value)
    } else if (name == "wukongim_channelappend_writer_pool_capacity") {
      effect_slots_capacity_max = max_value(effect_slots_capacity_max, value)
    } else if (name == "wukongim_channelappend_writer_state_items") {
    ...
    } else if (name == "wukongim_channelappend_effect_pool_inflight") {
    ...
    } else if (name == "wukongim_channelappend_effect_pool_capacity") {
      stage = default_label(stage)
      effect_pool_seen[stage] = 1
    ...
    } else if (name == "wukongim_channelappend_effect_pool_saturated") {
      stage = default_label(stage)
      effect_pool_seen[stage] = 1
  ...
  if (name == "wukongim_channelappend_router_total") {
  ...
  } else if (name == "wukongim_channelappend_router_duration_seconds_count") {
    add_counter("router_duration_count", phase, value)
  } else if (name == "wukongim_channelappend_router_duration_seconds_sum") {
    add_counter("router_duration_sum", phase, value)
  } else if (name == "wukongim_channelappend_local_admission_total") {
  ...
  } else if (name == "wukongim_channelappend_effect_total") {
  ...
  } else if (name == "wukongim_channelappend_effect_duration_seconds_count") {
    add_counter("effect_duration_count", phase, value)
  } else if (name == "wukongim_channelappend_effect_duration_seconds_sum") {
    add_counter("effect_duration_sum", phase, value)
  } else if (name == "wukongim_channelappend_effect_pool_submit_total") {
