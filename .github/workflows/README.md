...
| `three-node-chat-lifecycle-regression.yml` | `Safety Automation - Three-Node Chat Lifecycle Regression` | Runs benchmark-first PR regression and the nightly reviewed three-node staircase plus ten-minute 1,000 SEND/s qualification |
