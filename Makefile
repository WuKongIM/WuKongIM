...
deploy-v2-dev:
	...
	docker tag wukongim registry.cn-shanghai.aliyuncs.com/wukongim/wukongim:v2.2.0-20250426-dev-pebblev2
	docker push registry.cn-shanghai.aliyuncs.com/wukongim/wukongim:v2.2.0-20250426-dev-pebblev2
deploy-v2:
	docker buildx build -t wukongim . --platform linux/amd64,linux/arm64
	docker tag wukongim registry.cn-shanghai.aliyuncs.com/wukongim/wukongim:v2.1.5-20250424
	docker tag wukongim wukongim/wukongim:v2.1.5-20250424
	docker tag wukongim ghcr.io/wukongim/wukongim:v2.1.5-20250424
	docker tag wukongim ghcr.io/wukongim/wukongim:v2
	docker push registry.cn-shanghai.aliyuncs.com/wukongim/wukongim:v2.1.5-20250424
	docker push wukongim/wukongim:v2.1.5-20250424
