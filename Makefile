...
deploy-v1.2.x:
	docker build -t wukongim .
	docker tag wukongim registry.cn-shanghai.aliyuncs.com/wukongim/wukongim:v1.2.6
	docker tag wukongim wukongim/wukongim:v1.2.6
	docker push registry.cn-shanghai.aliyuncs.com/wukongim/wukongim:v1.2.6
	docker push wukongim/wukongim:v1.2.6
