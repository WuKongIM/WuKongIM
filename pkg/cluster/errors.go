...
var (
	...
	// ErrHashSlotMigrationDisabled reports that an operator-only hash-slot migration workflow is disabled.
	ErrHashSlotMigrationDisabled = errors.New("raftcluster: hash slot migration disabled")
...
func hashSlotMigrationDisabledConfigError() error {
	return fmt.Errorf("%w: %w", ErrInvalidConfig, ErrHashSlotMigrationDisabled)
}
