...
func (n *LocalNetwork) CallOwned(ctx context.Context, nodeID uint64, serviceID uint8, payload transport.OwnedBuffer) ([]byte, error) {
...
func (n *LocalNetwork) CallShardOwned(ctx context.Context, nodeID uint64, serviceID uint8, _ uint64, payload transport.OwnedBuffer) ([]byte, error) {
...
func (n *LocalNetwork) SendOwned(ctx context.Context, nodeID uint64, serviceID uint8, payload transport.OwnedBuffer) error {
