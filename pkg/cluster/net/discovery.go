...
// NodeAddress describes one node address visible to cluster RPC discovery.
...
// Resolve implements transport Discovery.
func (d *Discovery) Resolve(nodeID transport.NodeID) (string, error) {
