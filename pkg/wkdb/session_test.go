...
// 		SessionType: wkdb.SessionTypeCMD,
// 		Uid:         uid,
// 		ChannelId:   "test",
// 		ChannelType: 1,
// 		CreatedAt:   time.Now(),
...
// 	assert.NoError(t, err)
// 	assert.Equal(t, session.SessionType, resultSession.SessionType)
...
// 	sessions := []wkdb.Session{
// 		{
// 			SessionType: wkdb.SessionTypeChat,
// 			Uid:         uid,
// 			ChannelId:   "test1",
// 			ChannelType: 1,
// 			CreatedAt:   time.Now(),
...
// 	resultSessions, err := d.GetLastSessionsByUid(uid, wkdb.SessionTypeChat, 1)
// 	assert.NoError(t, err)
...
// 	resultSessions, err := d.GetSessionsGreaterThanUpdatedAtByUid(uid, wkdb.SessionTypeChat, sessions[0].UpdatedAt.UnixNano(), 0)
// 	assert.NoError(t, err)
// 	assert.Len(t, resultSessions, 1)
// 	assert.Equal(t, sessions[1].Uid, resultSessions[0].Uid)
// 	assert.Equal(t, sessions[1].ChannelId, resultSessions[0].ChannelId)
