...
`test/e2e/suite` and `test/e2ev2/suite` use the same package for CONNECT, crypto, SENDACK matching, and RECV decryption while keeping their old helper methods.
