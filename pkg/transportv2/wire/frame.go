...
const (
	// HeaderSize is the fixed byte size of every transportv2 frame header.
	HeaderSize = 24

	// Magic identifies transportv2 wire frames.
	Magic uint16 = 0x574b

	// Version is the supported transportv2 wire version.
	Version uint8 = 1
...
// Header is the fixed metadata prefix carried by every transportv2 frame.
type Header struct {
...
// DecodeHeader validates and decodes a fixed transportv2 wire header.
