...
const cardSpecs: CardSpec[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      { labelId: "clusterMonitor.stat.laggingSlots", value: "3" },
    ],
  },
  {
    key: "channelISRHealth",
    ...
    precision: 2,
    stats: [
      { labelId: "clusterMonitor.stat.isrInsufficient", value: "9" },
      { labelId: "clusterMonitor.stat.noLeader", value: "2" },
      { labelId: "clusterMonitor.stat.affectedChannels", value: "14" },
    ],
  },
  {
  ...
  },
  {
    ...
    stats: [
      { labelId: "clusterMonitor.stat.critical", value: "1" },
      { labelId: "clusterMonitor.stat.warning", value: "6" },
      { labelId: "clusterMonitor.stat.topReason", value: "rpc_timeout" },
    ],
  },
]
...
export function buildPreviewClusterMonitorModel(
  ...
  const snapshot: ClusterMonitorSnapshotEntry[] = [
    ...
    { key: "channelISRAnomalies", labelId: "clusterMonitor.snapshot.channelISRAnomalies", value: "14", tone: "warning" },
