...
function makeSnapshot(cards: MonitorMetricCard[]): MonitorSnapshotEntry[] {
  ...
  return [
    ...
    { key: "conversationSyncErrors", labelId: "monitor.snapshot.conversationSyncErrors", value: byKey.get("conversationSyncErrorRate")?.value ?? "-", unit: "%", tone: "normal" },
    ...
    { key: "conversationFlushErrors", labelId: "monitor.snapshot.conversationFlushErrors", value: byKey.get("conversationActiveFlushErrorRate")?.value ?? "-", unit: "%", tone: "normal" },
